// Vercel serverless function — exchanges a refresh token for a new access
// token. Split out from whoop-callback.js because this one is called
// repeatedly from the frontend (every ~hour) rather than once per login.
